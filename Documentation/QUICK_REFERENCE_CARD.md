# Quansheng UV-K5, K5(8)/K6 (Version 1 Only) ApeX Edition - QUICK REFERENCE CARD
...
- **GitHub Repository**: https://github.com/QSUVKSeries/UV-K5v1_ApeX-Edition
- **Issue Tracker**: Report bugs with radio model + firmware version
- **Community Wiki**: FAQs and advanced usage

---

**Document Version**: 1.1 (Firmware 7.6.0+)  
