...
enum BEEP_Type_t
{
    ...
    /** @brief 270 Hz / 1000 ms — repeated low-battery escalation tone.
     *  Always audible (not gated by BEEP_CONTROL) so a dying battery
     *  can still warn the user even if beeps are otherwise disabled. */
    BEEP_880HZ_300MS_LOW_BATTERY_CRITICAL
};
