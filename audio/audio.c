...
void AUDIO_PlayBeep(BEEP_Type_t Beep)
{
    ...
    if (Beep != BEEP_880HZ_60MS_DOUBLE_BEEP &&
        ...
        Beep != BEEP_880HZ_300MS_LOW_BATTERY_CRITICAL &&
    ...
    if (gCurrentFunction == FUNCTION_RECEIVE && Beep != BEEP_880HZ_300MS_LOW_BATTERY_CRITICAL)
        return;

    if (gCurrentFunction == FUNCTION_MONITOR && Beep != BEEP_880HZ_300MS_LOW_BATTERY_CRITICAL)
        return;
    ...
    switch (Beep)
    {
        ...
        case BEEP_1KHZ_60MS_OPTIONAL:
            ToneFrequency = 1000;
            break;
        case BEEP_880HZ_300MS_LOW_BATTERY_CRITICAL:
            ToneFrequency = 880;
            break;
