...
/* Low-battery escalation state (K1-style).
 * Exposed so the UI layer can render the countdown value in the
 * low-battery popup without duplicating the state. */
extern uint16_t gLowBatteryPopupCountdown;
extern uint8_t  gLowBatteryEscalationLevel;
