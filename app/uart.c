...
// Ring buffer optimization: use bitwise AND for 256-byte buffer (faster than modulo)
// Works because sizeof(UART_DMA_Buffer) == 256 (power of 2)
...
static void SendVersion(void)
{
    ...
    // Safe string copy with bounds checking to prevent overflow
