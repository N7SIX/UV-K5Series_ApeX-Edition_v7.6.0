 ...
 * This module manages the interactive menu system, configuration storage,
...
int MENU_GetLimits(uint8_t menu_id, int32_t *pMin, int32_t *pMax)
{
    *pMin = 0;
    ...
    switch (menu_id)
    {
        ...
        case MENU_BATCAL:
            *pMin = 1400;  // Low ADC for 5.20V
            *pMax = 3500;  // High ADC for 7.60V, expanded for maximum hardware variations
            break;
...
//          gRequestSaveChannel = 1;
        ...
        {                                                                // voltages are averages between discharge curves of 1600 and 2200 mAh
            ...
            gBatteryCalibration[3] =          gSubMenuSelection;         // 7.6V full reference
            ...
            // Reset runtime calibration to force re-initialization with new values
            gBatteryCalib.BatLo = 0;
