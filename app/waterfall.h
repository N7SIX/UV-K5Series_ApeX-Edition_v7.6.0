 ...
 *
 * LCD pregeom: (ST7565, 128x64, pageed):
 * gFrameBuffer[5] = page 6 = lines 48-55
 * gFrameBuffer[6] = page 7 = lines 56-63
 *
 * Waterfall history: circular buffer, 128 columns x 16 rows, 4-bit/he pixel packed.
 * Grayscale via 4x4 Bayer ordered dither.
 *
 * NOTE: This feature is disabled by default. Enable with ENABLE_WATERFALL=1 in Makefile.
 */
...
/* Push a listening row: one column boosted to signal brightness, rest
