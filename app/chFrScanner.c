...
# * =====================================================================================
# * @file        chFrScanner.c
# * @brief       Channel/frequency scanner logic for Quansheng UV-K5 v1 Series
...
# * This module implements the scanning engine for channels and frequency
# * ranges, supporting scan lists, dual watch, and advanced pause logic.
# *
