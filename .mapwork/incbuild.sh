...
run "baseline_r3" "-flto-partition=none" "-flto-partition=none"

echo "--- 2: gold --icf=all ---"
run "gold_icf_r3" "-flto-partition=none" "-flto-partition=none -fuse-ld=gold -Wl,--icf=all"

echo "RESULT: flasher limit 61439; round2 best was 61884"
