...
// dBm correction table for each frequency band
const int8_t dBmCorrTable[BAND_N_ELEM] = {
    0, 0, 0, 0, 0, 0, 0
};
...
bool          gSetting_set_ptt_session = 0;
...
volatile uint16_t gPowerSave_10ms = 0;
...
BatteryCalibration_t gBatteryCalib = {0, 0};
uint16_t            gBatteryCalibration[6] = {0};
uint16_t            gBatteryVoltages[4] = {0};
uint16_t            gBatteryVoltageAverage = 0;
uint16_t            gBatteryCurrentVoltage = 0;
uint16_t            gBatteryCurrent = 0;
uint16_t            gBatteryCheckCounter = 0;
uint8_t             gBatteryDisplayLevel = 0;
uint8_t             gBatteryPercent = 0;
bool                gChargingWithTypeC = false;
bool                gLowBattery = false;
bool                gLowBatteryBlink = false;
bool                gLowBatteryConfirmed = false;
uint16_t            gLowBatteryPopupCountdown = 0;
uint8_t             gLowBatteryEscalationLevel = 0;
...
uint8_t           gIsLocked = 0xFF;
    ...
    uint8_t       gSquelchLevelOriginal;
    uint8_t       gPttOnePushCounter = 0;
    uint32_t      gBlinkCounter = 0;
    bool          gAirCopyBoot = false;
#endif
...
bool SerialConfigInProgress(void) {
