...
/** @brief PMR446/FRS non-homologated CTCSS option indices (K1 v7.6.10D lineage). */
extern const uint8_t CTCSS_ExtraIdx[12];
/** @brief PMR446/FRS non-homologated DCS option indices (K1 v7.6.10D lineage). */
extern const uint8_t DCS_ExtraIdx[21];

/** @brief Return the approved CSS option index for Option, or 0xFF if non-homologated. */
uint8_t DCS_GetCtcssApprovedIndex(uint8_t Option);
/** @brief Return the approved DCS option index for Option, or 0xFF if non-homologated. */
